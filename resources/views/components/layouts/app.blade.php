...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Sub like siêu tốc" />
    <meta name="keywords" content="sub, like, via, bm" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Sublikesieutoc - Sub like giá siêu rẻ" />
                ...
                <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                    ...
                    <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="{{ route('logout') }}" class="menu-link px-5">{{ __('filament-panels::widgets/account-widget.actions.logout.label') }}</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                    ...
                    <div class="app-navbar-item ms-2 ms-lg-6 me-lg-6">
                        @guest()
                        <!--begin::Link-->
                        <a href="" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
